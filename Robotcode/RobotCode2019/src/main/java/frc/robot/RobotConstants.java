...
public class RobotConstants {
    ...
    //PWM/Motor
    public static final int INTAKE_LEFT_MOTOR_PWM_PORT = 0;
    public static final int INTAKE_RIGHT_MOTOR_PWM_PORT = 1;
    ...
    public static final int CLIMBER_SERVO1=7;
    public static final int CLIMBER_SERVO2=8;
